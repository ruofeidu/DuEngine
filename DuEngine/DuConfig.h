...
class DuConfig {
 ...
 public:
  std::string GetStringWithDefault(const std::string &name,
                                   const std::string &defaultValue) const;
  std::wstring GetWStringWithDefault(const std::string &name,
  ...
  double GetDoubleWithDefault(const std::string &name,
