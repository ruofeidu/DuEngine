...
string PathManager::getShader(string str) {
	return m_shadersPath + str;
}

string PathManager::getPreset(string str) {
	return m_presetsPath + str;
}
...
string PathManager::getVertexShader() {
	return m_config->GetStringWithDefault("shader_vert", m_shadersPath + "shadertoy.vert.glsl");
}

string PathManager::getUniformShader() {
	return m_config->GetStringWithDefault("shader_uniform", m_shadersPath + "shadertoy.uniforms.glsl");
}

string PathManager::getMainShader() {
	return m_config->GetStringWithDefault("shader_main", m_shadersPath + "shadertoy.main.glsl");
}

string PathManager::getFragmentShader(string bufferSuffix) {
	auto res = m_config->GetStringWithDefault("shader_frag", m_shadersPath + "shadertoy.default.glsl");
